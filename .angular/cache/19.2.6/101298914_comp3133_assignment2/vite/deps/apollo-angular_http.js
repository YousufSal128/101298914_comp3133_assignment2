import "./chunk-V3YHE6QE.js";
import {
  ApolloLink,
  Observable as Observable2
} from "./chunk-FCYMIMUI.js";
import "./chunk-JHISNTPZ.js";
import {
  print
...
import {
  HttpClient,
  HttpHeaders
} from "./chunk-3N5UYQBD.js";
import "./chunk-AAUFHXFT.js";
import {
  Injectable,
  Observable,
  setClassMetadata,
...
// node_modules/apollo-angular/fesm2020/ngApolloLinkHttp.mjs
...
HttpLink.ɵfac = function HttpLink_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || HttpLink)(ɵɵinject(HttpClient));
};
HttpLink.ɵprov = ɵɵdefineInjectable({
  token: HttpLink,
...
HttpBatchLink.ɵfac = function HttpBatchLink_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || HttpBatchLink)(ɵɵinject(HttpClient));
};
HttpBatchLink.ɵprov = ɵɵdefineInjectable({
  token: HttpBatchLink,
